      ...
      <div className="section-container">
        ...
        <div className="grid lg:grid-cols-2 gap-6 items-start">
          ...
          >
            ...
            <h3 style={{ fontWeight: 700, fontSize: '1.2rem', marginBottom: '0.6rem' }}>Open to opportunities</h3>
            ...
            <div className="flex flex-col gap-2.5">
              <a href={`mailto:${mail}?subject=${subject}`} className="btn-primary" style={{ justifyContent: 'center' }}>
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
                  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/>
                </svg>
                Email me
              </a>
              <a href="/resume.pdf" className="btn-outline" style={{ justifyContent: 'center' }}>
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
            ...
            <div style={{ marginTop: '1.25rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.4rem', color: 'var(--muted-2)', fontSize: '0.78rem' }}>
          ...
          <div className="flex flex-col gap-3">
            {contactLinks.map((c, i) => (
              <motion.a
                ...
                className="card"
                style={{ padding: '1rem 1.25rem', display: 'flex', alignItems: 'center', gap: '0.9rem', textDecoration: 'none' }}
                initial={{ opacity: 0, x: 16 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.4, delay: i * 0.08 }}
              >
                <div style={{ width: 40, height: 40, borderRadius: 9, background: `${c.color}10`, border: `1px solid ${c.color}22`, display: 'flex', alignItems: 'center', justifyContent: 'center', color: c.color, flexShrink: 0 }}>
                  {c.icon}
                </div>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontWeight: 600, fontSize: '0.875rem', marginBottom: '0.1rem' }}>{c.label}</div>
                  <div style={{ color: 'var(--muted)', fontSize: '0.78rem', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{c.value}</div>
                </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.45rem', color: 'var(--muted-2)', fontSize: '0.78rem', padding: '0.5rem 0' }}>
