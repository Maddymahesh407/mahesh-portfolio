...
const timeline = [
  {
    ...
    type: 'Current Role',
    typeColor: '#a78bfa',
    desc: 'Leading full-stack development of MORO, a robotics-based product — owning end-to-end architecture across frontend, backend, and software integration.',
    bullets: [
      'Designed and optimised REST API endpoints and core routing logic for the MORO platform, enabling reliable robot-control communication.',
      'Conducted code reviews and led QA testing cycles, maintaining code quality across sprint iterations.',
      'Mentored junior developers and coordinated cross-functionally with product, design, and engineering stakeholders.',
    ],
    tags: ['Node.js', 'REST APIs', 'Robotics', 'Team Lead', 'Agile'],
  },
  {
      ...
      <div className="section-container">
            ...
            {timeline.map((t, i) => (
              ...
              >
                <div
                  ...
                  style={{ background: t.typeColor, boxShadow: `0 0 10px ${t.typeColor}55` }}
                />
                ...
                <div className="card" style={{ padding: '1.5rem' }}>
                    ...
                    <div>
                      <div className="flex items-center gap-2 flex-wrap" style={{ marginBottom: '0.2rem' }}>
                        ...
                        <span style={{
                          ...
                          background: `${t.typeColor}12`,
                          border: `1px solid ${t.typeColor}28`,
                          color: t.typeColor,
                        }}>
                          {t.type}
                        </span>
                  ...
                  {/* Description */}
                  <p style={{ color: 'var(--muted)', lineHeight: 1.7, fontSize: '0.875rem', marginBottom: '0.75rem' }}>
                    {t.desc}
                  </p>
        ...
        <div style={{ marginTop: '1.5rem' }}>
          ...
          <div className="flex flex-col gap-3">
            ...
            <motion.div
              className="card"
              style={{ padding: '1.1rem 1.5rem', display: 'flex', gap: '0.9rem', alignItems: 'center' }}
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ color: 'var(--muted)', fontSize: '0.8rem' }}>
                  REVA University, Bangalore · CGPA: 8.40 (Sem 1–3) · 2024 – Present
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ color: 'var(--muted)', fontSize: '0.8rem' }}>
                  Nazareth College of Arts and Science, Tiruvallur · CGPA: 7.26 · 2021 – 2024
                </div>
              </div>
            </motion.div>
        ...
        <div style={{ marginTop: '0.75rem' }}>
          ...
          <motion.div
            className="card"
            style={{ padding: '1.1rem 1.25rem', display: 'flex', gap: '0.75rem', alignItems: 'flex-start' }}
            initial={{ opacity: 0, y: 14 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            <div>
              ...
              <div style={{ color: 'var(--muted)', fontSize: '0.78rem' }}>
                Azure AI Fundamentals · Certified 2026
              </div>
            </div>
          </motion.div>
          ...
          <motion.div
            className="card"
            style={{ padding: '1.1rem 1.25rem', display: 'flex', gap: '0.75rem', alignItems: 'flex-start', flexDirection: 'column' }}
            initial={{ opacity: 0, y: 14 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'flex-start', width: '100%' }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ color: 'var(--muted)', fontSize: '0.78rem' }}>
                  Biometric fingerprint auth via Aadhaar · No: 202541065407 · 2025
                </div>
              </div>
            </div>
            ...
            >
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                ...
                style={{ transition: 'transform 0.2s', transform: patentExpanded ? 'rotate(90deg)' : 'rotate(0deg)' }}
                aria-hidden>
            ...
            <AnimatePresence>
              {patentExpanded && (
                <motion.div
                  ...
                  style={{ overflow: 'hidden', marginTop: '0.75rem', paddingTop: '0.75rem', borderTop: '1px solid var(--border)' }}
                >
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
                    <div>
                      <div style={{ fontSize: '0.72rem', fontWeight: 600, color: '#f59e0b', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.3rem' }}>
                        Technical Innovation
                      </div>
                      <div style={{ fontSize: '0.78rem', color: 'var(--muted)', lineHeight: 1.5 }}>
                        Biometric identity verification system integrating Aadhaar fingerprint authentication with real-time verification layer using AWS Rekognition and encryption protocols.
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <ul style={{ fontSize: '0.78rem', color: 'var(--muted)', margin: 0, paddingLeft: '1.25rem', lineHeight: 1.6 }}>
                        <li>Secure Aadhaar biometric integration</li>
                        <li>Real-time fingerprint matching algorithm</li>
                        <li>Encrypted credential storage & transmission</li>
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: '0.78rem', color: 'var(--muted)', lineHeight: 1.5 }}>
                        Digital identity verification for fintech platforms, government services, and secure document authentication systems.
                      </div>
                    </div>
                  </div>
                </motion.div>
