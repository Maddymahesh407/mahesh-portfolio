...
const ROLES = [
  { text: 'Backend & AI Developer',    color: '#a78bfa' }, // purple
  { text: 'Full-stack Developer',      color: '#60a5fa' }, // blue
  { text: 'Backend Systems Developer', color: '#34d399' }, // green
]
...
function useTypingAll() {
  ...
  useEffect(() => {
    ...
    if (current.length < target.text.length) {
      ...
      // Current line fully typed — move it to completed
      const t = setTimeout(() => {
      ...
      <div className="section-container">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="flex-1 min-w-0 w-full">
            ...
            {/* Typing role lines — all typed once, stay visible */}
            <motion.div
              style={{
                marginTop: '0.85rem',
                marginBottom: '1.1rem',
            ...
            >
              ...
              {!done && (
                <div style={{
                  ...
                  <span style={{
                    width: 5, height: 5, borderRadius: '50%',
                    background: ROLES[lineIdx].color, flexShrink: 0,
                    opacity: 0.8,
                  }} aria-hidden />
                  <span>{current}</span>
                  <span style={{
                    ...
                    width: 2,
                    height: '1em',
                    background: ROLES[lineIdx].color,
                    borderRadius: 1,
